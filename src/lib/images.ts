...
const CORE = {
  ...
  logos: {
    ...
    bwc: `${SUPABASE_URL}/Bwc%20logo.JPG`,
    cartHorse: `${SUPABASE_URL}/cart-horse-favicon-black.png`,
    mbs: `${SUPABASE_URL}/Cropped%20MBS%20Logo%20(1).webp`,
    drPhil1: `${SUPABASE_URL}/DR%20PHIL%20LOGO%20NPO_OMNI-01.png`,
    drPhil2: `${SUPABASE_URL}/DR%20PHIL%20LOGO%20NPO_OMNI-02.png`,
    gorachouqua: `${SUPABASE_URL}/Gorachouqua-Logo-300x300.png`,
    justLogos: `${SUPABASE_URL}/Just%20logos%20(1).png`,
    kai: `${SUPABASE_URL}/Kai%20Logo%20BW.png`,
    ttct: `${SUPABASE_URL}/logo%20tt%20ct%20(1).png`,
    muddyRambler: `${SUPABASE_URL}/Muddy%20Rambler%20Logo%20Square%20White.png`,
    muizKitchen: `${SUPABASE_URL}/muiz-kitchen-logo3.jpg`,
    newLogo: `${SUPABASE_URL}/New%20logo%20(1)%20(1).png`,
