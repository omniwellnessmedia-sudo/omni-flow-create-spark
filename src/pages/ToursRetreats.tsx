...
const sampleToursRetreats: WellnessExperience[] = [
  {
    ...
    title: 'Sacred Cave Healing: Muizenberg Wellness Journey',
    description: 'Where ancient Khoi-San wisdom meets modern therapeutic practice. Evidence-based program combining indigenous healing with trauma-informed care in sacred cave spaces.',
    longDescription: 'Transform through an academic wellness journey that integrates indigenous Khoi-San healing traditions with contemporary therapeutic modalities. This evidence-based program uses sacred cave spaces for breathwork, somatic practices, and cultural immersion. 20% of proceeds support the Dr. Phil-afel Foundation community programs. Participants achieve 40% stress reduction and enhanced cultural competency through experiential learning with traditional healers.',
    provider_id: 'fact-wellness',
    provider_name: 'FACT Wellness Center',
    category: 'Wellness Retreats',
    subcategory: 'Healing & Transformation',
    images: [getStorageUrl('muizenberg cave view.jpg'), getStorageUrl('group tour amazing cave view.jpg'), getStorageUrl('fact-wellness-hero.jpg')],
    ...
    rating: 4.8,
    review_count: 247,
    tags: ['cave-healing', 'indigenous', 'therapeutic', 'academic', 'south-africa', 'wellness'],
    price_zar: 3999,
    ...
    includes: ['Sacred cave ceremonies', 'Indigenous healer guidance', 'Academic materials', 'Community service', 'Dr. Phil-afel Foundation support (20%)', 'All wellness activities'],
  ...
  },
  {
    ...
    content_type: 'experience',
    title: 'Conscious Connections: Learn from Chief Kingsley',
    description: 'Direct teachings from Chief Kingsley, custodian of Khoi-San healing traditions. Authentic indigenous wisdom, healing ceremonies, and cultural immersion in the Eastern Cape.',
    longDescription: 'Journey into the heart of indigenous wisdom with Chief Kingsley, a respected knowledge keeper of Khoi-San healing traditions. This transformative program offers direct cultural transmission through healing circles, traditional medicine education, and ceremony participation. Experience Ubuntu philosophy in practice while supporting the Dr. Phil-afel Foundation\'s community initiatives. 85% of participants report improved cultural competency and relational capacity.',
    provider_id: 'conscious-connections',
    provider_name: 'Conscious Connections SA',
    category: 'Indigenous Wisdom',
    subcategory: 'Cultural Immersion',
    images: [getStorageUrl('indigenous tour chief kingsley explaining.jpg'), getStorageUrl('Chief Kingsley amazing portrait.jpg'), getStorageUrl('traditional-healing-experience.jpg')],
    ...
    rating: 4.9,
    review_count: 127,
    tags: ['indigenous', 'chief-kingsley', 'healing', 'ceremonies', 'traditional', 'ubuntu', 'south-africa'],
    price_zar: 3999,
    price_wellcoins: 3200,
    experience_type: 'retreat',
    ...
    max_participants: 12,
    current_participants: 8,
    includes: ['Chief Kingsley teachings', 'Healing ceremonies', 'Traditional medicine education', 'Cultural protocol training', 'Community meals', 'Dr. Phil-afel Foundation support (20%)', 'Transportation'],
    accommodation_included: true,
    meals_included: true,
    transport_included: true,
    difficulty_level: 'all_levels'
  },
  {
    ...
    content_type: 'experience',
    title: 'Ubuntu Immersion: "I Am Because We Are"',
    description: 'Experience African philosophy of interconnectedness through community-based healing, village elder teachings, and collective transformation.',
    longDescription: 'Immerse yourself in Ubuntu - the profound African philosophy that we are all interconnected. Through community living, village elder wisdom, traditional storytelling, and collective healing practices, discover the power of "I am because we are." This program directly supports Dr. Phil-afel Foundation\'s community development initiatives, creating measurable impact while deepening your understanding of relational healing and collective well-being.',
    provider_id: 'ubuntu-collective',
    provider_name: 'Ubuntu Healing Collective',
    category: 'Wellness Retreats',
    subcategory: 'Community Healing',
    images: [getStorageUrl('ubuntu-community-gathering.jpg'), getStorageUrl('ubuntu-healing-circle.jpg'), getStorageUrl('community outing 1.jpg')],
  ...
  },
  {
    ...
    rating: 4.8,
    review_count: 156,
    tags: ['ubuntu', 'community', 'healing', 'philosophy', 'collective-healing', 'african-wisdom'],
    price_zar: 3499,
    ...
    includes: ['Community living', 'Elder teachings', 'Healing circles', 'Traditional meals', 'Storytelling sessions', 'Dr. Phil-afel Foundation support (20%)', 'Transportation'],
    accommodation_included: true,
    meals_included: true,
    transport_included: true,
    difficulty_level: 'all_levels'
  ...
  {
    id: 'service-learning-cape-town',
    content_type: 'experience',
    title: 'Cape Town Service Learning: Transform Communities',
    description: 'Academic service-learning program directly supporting Dr. Phil-afel Foundation. Participate in community development, education programs, and urban gardening while earning academic credit.',
    longDescription: 'Make a tangible difference while transforming yourself. This comprehensive service-learning program partners with the Dr. Phil-afel Foundation to support education for 100+ children, women\'s empowerment, and urban gardening initiatives. Participants engage in real community development projects, receive cultural competency training, and can earn 12-16 transferable academic credits. See exactly how your participation creates measurable impact in Cape Town communities.',
    provider_id: 'omni-wellness',
    provider_name: 'Omni Wellness Education',
    category: 'Study Abroad',
    subcategory: 'Service Learning',
    images: [getStorageUrl('service-learning-hero.jpg'), getStorageUrl('service-learning-education.jpg'), getStorageUrl('service-learning-garden.jpg')],
    ...
    rating: 4.9,
    review_count: 203,
    tags: ['service-learning', 'education', 'community-development', 'academic', 'dr-phil-afel', 'impact'],
    price_zar: 4499,
    price_wellcoins: 3600,
    ...
    includes: ['Academic credit (12-16 units)', 'Dr. Phil-afel Foundation partnership', 'Community project work', 'Cultural training', 'Accommodation', 'Meals', 'Local transportation', 'Project materials'],
    accommodation_included: true,
    meals_included: true,
    transport_included: true,
    difficulty_level: 'all_levels'
