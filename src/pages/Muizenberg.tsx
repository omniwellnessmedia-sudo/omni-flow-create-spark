...
import { SPECTRUM, getOffer } from '@/data/publicRateCard';
      ...
      <main>
        ...
        <section className="px-4 pb-14 pt-28 sm:px-6 lg:px-8 lg:pt-36">
          <div className="mx-auto max-w-5xl">
            ...
            <h1
              className="mt-5 max-w-3xl font-wwpl-display text-[42px] leading-[1.02] sm:text-[58px] lg:text-[68px]"
              style={{ color: INK }}
            >
        ...
        <section className="px-4 py-16 sm:px-6 lg:px-8 lg:py-24" style={{ background: CREAM }}>
          <div className="mx-auto max-w-5xl">
            ...
            <p className="mt-8 text-[14px]" style={{ color: SLATE }}>
        ...
        <section className="px-4 py-16 sm:px-6 lg:px-8 lg:py-24" style={{ background: INK, color: CREAM }}>
          <div className="mx-auto max-w-5xl">
            <Reveal>
              ...
              <h2 className="mt-4 max-w-3xl font-wwpl-display text-[34px] leading-tight sm:text-[46px]">
                Work local businesses can afford, done by local people.
              </h2>
              <div className="mt-6 grid gap-6 text-[16px] leading-relaxed lg:grid-cols-2" style={{ color: 'rgba(250,248,242,.78)' }}>
                <p>
