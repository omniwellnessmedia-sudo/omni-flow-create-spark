                    ...
                    <div className="space-y-4">
                      {category.items.map((item, itemIndex) => (
                        <div key={itemIndex} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                          ...
                          <a
                            href={`mailto:omniwellnessmedia@gmail.com?subject=Resource Request: ${encodeURIComponent(item.title)}&body=Hi, I would like to request the ${encodeURIComponent(item.title)} resource. Thank you.`}
                          >
