  ...
  return (
    <div className="min-h-screen">
      ...
      <Hero
        title={
          <>
            <span className="bg-rainbow-gradient bg-clip-text text-transparent">Resources</span> & Downloads
          </>
        }
        ...
        <section id="resources" className="section-spacing bg-white">
          <div className="container-width">
            <div className="text-center mb-16">
              <h2 className="bg-rainbow-gradient bg-clip-text text-transparent text-4xl md:text-5xl font-bold mb-6">
                ...
                <Card key={category.category} className="group hover:shadow-lg transition-all duration-300">
                  <CardHeader>
                    <div className="flex items-center gap-3 mb-3">
                      <div className="w-12 h-12 bg-rainbow-gradient rounded-lg flex items-center justify-center">
                        <category.icon className="w-6 h-6 text-white" />
                      </div>
                      <CardTitle className="bg-rainbow-gradient bg-clip-text text-transparent">
                        {category.category}
                      </CardTitle>
                    </div>
                  </CardHeader>
                      ...
                      {category.items.map((item, itemIndex) => (
                        <div key={itemIndex} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                          <div className="flex-1">
                            ...
                            <span className="inline-block px-2 py-1 bg-rainbow-gradient text-white text-xs rounded-full">
                              {item.type}
                            </span>
                          </div>
        ...
        <section className="section-spacing bg-gray-50">
          <div className="container-width">
            <div className="max-w-2xl mx-auto text-center">
              <h2 className="bg-rainbow-gradient bg-clip-text text-transparent text-3xl md:text-4xl font-bold mb-6">
                Stay Updated
              </h2>
