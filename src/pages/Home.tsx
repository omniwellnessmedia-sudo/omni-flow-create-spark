          ...
          <div className="text-center py-20">
            <div className="flex justify-center mb-6">
              <img 
                ...
                className="h-24 w-24 lg:h-32 lg:w-32 animate-float object-contain"
              />
            </div>
            
            <h1 className="text-4xl lg:text-6xl font-bold mb-6">
              <span className="text-rainbow-enhanced">Bridging Wellness,</span>
              <br />
              <span className="text-gray-900">Outreach & Media</span>
            </h1>
            
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Empowering South Africa's journey to health & consciousness through conscious content creation, business development, and sustainable solutions.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild className="bg-wellness-primary hover:bg-wellness-primary/90 text-white px-8 py-3">
                <Link to="/services">Learn More</Link>
              </Button>
              <Button asChild variant="outline" className="border-wellness-primary text-wellness-primary hover:bg-wellness-primary hover:text-white px-8 py-3">
