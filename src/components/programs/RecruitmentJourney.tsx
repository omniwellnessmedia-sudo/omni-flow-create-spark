...
const handleAction = (action: string) => {
  const actions: Record<string, () => void> = {
    ...
    email: () => { window.location.href = 'mailto:admin@omniwellnessmedia.co.za?subject=UWC Programme Inquiry'; },
    apply: () => { window.location.href = 'mailto:admin@omniwellnessmedia.co.za?subject=UWC Programme Application&body=I would like to express my interest in the UWC Human-Animal Interaction Programme.%0A%0AName:%0AEmail:%0ACountry:%0AInstitution (if applicable):%0A%0AWhy I am interested:'; },
