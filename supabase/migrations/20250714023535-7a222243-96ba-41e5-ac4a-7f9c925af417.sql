-- Fix image paths to use the correct public folder structure
UPDATE tours 
...
WHERE title = 'Winter Warmth: Fireplace Yoga & Meditation';
...
WHERE title = 'Cape Point Winter Adventure & Natural Hot Springs';
...
WHERE title = 'Winter Wine Country Wellness Weekend';

UPDATE tours 
SET hero_image_url = '/lovable-uploads/88a81b0a-9d73-46f4-b070-762b9eb15a61.png',
    image_gallery = ARRAY[
      '/lovable-uploads/88a81b0a-9d73-46f4-b070-762b9eb15a61.png',
      '/lovable-uploads/ce7e6e42-f6c8-4108-a457-03a90f14a5b7.png',
      '/lovable-uploads/16362f62-3b3d-4bfa-af12-d0b98988b086.png'
    ]
WHERE title = 'Cape Town Service Learning Program';
...
WHERE title = 'Monthly Wellness Workshop Series';
