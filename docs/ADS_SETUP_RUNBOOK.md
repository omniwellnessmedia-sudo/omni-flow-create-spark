# Google Ads Runbook — Omni Wellness Media — **FINAL v1.2 (SOURCE-OF-TRUTH ALIGNED)**
...
- **Quicket booking page (where all tickets actually sell):** `https://qkt.io/Eu8CpR` — get the full `quicket.co.za/...` URL from Chad before using Quicket-direct as an ad final URL
